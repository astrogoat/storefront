...
>
    <div class="bg-white">
        <div class="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8 lg:pb-24">
            <div class="max-w-xl">
                ...
                <div class="space-y-20">
                    <div>
                        <div class="rounded-lg bg-gray-50 px-4 py-6 sm:flex sm:items-center sm:justify-between sm:space-x-6 sm:px-6 lg:space-x-8">
                            <dl class="flex-auto text-sm text-gray-600 sm:grid sm:grid-cols-3 sm:gap-x-6 sm:space-y-0 lg:w-1/2 lg:flex-none lg:gap-x-8">
                                ...
                                <tr>
                                    <td class="py-6 pr-8">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                <div class="font-medium text-gray-900">{{ $orderRecord->product->title }}</div>
