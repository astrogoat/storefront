<x-fab::layouts.page
    ...
    :breadcrumbs="[
            ...
            ['title' => 'Collections', 'url' => route('lego.storefront.orders.index')],
            ['title' => 'new order'],
        ]"
    x-data=""
...
>
    ...
    <x-fab::layouts.main-with-aside>
        ...
        >
            <x-fab::forms.input
                label="Name"
                wire:model="model.customer_name"
            />
            <div class="grid grid-cols-2 gap-2">
                <x-fab::forms.input
                    label="Email"
                    wire:model="model.customer_email"
                />
                <x-fab::forms.input
                    label="Phone"
                    wire:model="model.customer_phone"
                />
            </div>
        </x-fab::layouts.panel>
        ...
        >
            <div class="grid grid-cols-2 gap-2">
                <x-fab::forms.input
                    label="Street"
                    wire:model="model.customer_street"
                />
                <x-fab::forms.input
                    label="City"
                    wire:model="model.customer_city"
                />
                <x-fab::forms.input
                    label="State/Province"
                    wire:model="model.customer_state"
                />
                <x-fab::forms.select
                    label="Country"
                    wire:model="model.customer_country"
                >
        ...
        <x-fab::layouts.panel
            title="Products"
            description="Link products to this order"
            class="sh-mt-4"
            allow-overflow
                        ...
                        >
                            ...
                            <x-slot name="actions">
                                <x-fab::elements.button
                                    size="xs"
                                    type="link"
                                    :url="route('lego.storefront.products.edit', $product['id'])"
                                >
                                    View
                                </x-fab::elements.button>
        ...
        <x-slot name="aside">
            ...
            >
                <x-fab::forms.select
                    ...
                    help="If this is an already made sale, you can choose 'Delivered' as the status to add it at a sale, else it would display on the 'orders' table."
                >
